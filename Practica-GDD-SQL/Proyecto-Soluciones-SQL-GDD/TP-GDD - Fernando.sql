/* Creacion de Squema FJGD-sql */

CREATE SCHEMA FJGD AUTHORIZATION dbo;
 
CREATE PROCEDURE [FJGD].[ActualizarDatos] (@DiasAnteriores int)
AS

	DECLARE @FechaAnterior DATE
	SET @FechaAnterior = DATEADD(DAY, -@DiasAnteriores, getdate())

	update [dbo].[Issues$] set Componentes='Atención al cliente' where [Clave]='CORE-1515' OR [Clave]='CORE-1516'



/* Creacion de la base de datos */

CREATE PROCEDURE ActualizarDatos (@DiasAnteriores int)
AS
